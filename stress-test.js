...
dotenv.config();
const key = process.env.TREASURY_KEY;
const from = process.env.TREASURY_WALLET;
...
const mint = async () => {
  ...
  try {
    ...
    'object' === typeof e ? console.log(e + '') : console.log(e);
    console.log(
      `(${explorer}).sc(${factoryAddress}).methods.mint(nftAddress ${nftAddress}, userAddress ${userAddress}, tokenId ${tokenId--})`,
    );
    return;
  }
  ...
  try {
    ...
    console.log({ explorer, transactionHash });
  } catch (e) {
    'object' === typeof e ? console.log(e + '') : console.log(e);
    console.log(
      `(${explorer}).sc(${factoryAddress}).methods.mint(nftAddress ${nftAddress}, userAddress ${userAddress}, tokenId ${tokenId--})`,
