...
const nftAddress = '0xc99c679c50033bbc5321eb88752e89a93e9e83c5';
...
const events = await new web3.eth.Contract(nftAbi, nftAddress).getPastEvents('ApprovalForAll', {
  fromBlock: 0,
  toBlock: 9999999999,
});
...
for (let i = 0; i < events.length; i++) {
  const e = events[i];
  const element = e.returnValues.operator.toLowerCase();
